<template>
  <el-dialog
    ...
    <el-form-item label="改变值, 正负计数" prop="changeCount">
      <el-input v-model="dataForm.changeCount" placeholder="改变值, 正负计数"></el-input>
    </el-form-item>
    <el-form-item label="P.S." prop="note">
      <el-input v-model="dataForm.note" placeholder="P.S."></el-input>
    </el-form-item>
    <el-form-item label="0:扫描, 1:搜索, 2:分享" prop="sourceType">
      <el-input v-model="dataForm.sourceType" placeholder="0:扫描, 1:搜索, 2:分享"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          changeCount: [
            { required: true, message: '改变值, 正负计数不能为空', trigger: 'blur' }
          ],
          note: [
            { required: true, message: 'P.S.不能为空', trigger: 'blur' }
          ],
          sourceType: [
            { required: true, message: '0:扫描, 1:搜索, 2:分享不能为空', trigger: 'blur' }
          ],
          delFlag: [
            { required: true, message: '不能为空', trigger: 'blur' }
          ],
